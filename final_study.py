...
def link_user_to_pics(username):
    ...
    return gr.Tab(label="training", interactive=True)
...
with gr.Blocks() as study:
    ...
    with gr.Tab(interactive=False) as training_tab:
    ...
    with gr.Tab(label="main", interactive=study_active):
